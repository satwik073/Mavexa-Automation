'use client'
import { EditorCanvasTypes , EditorNodeType } from '@/lib/constants'
...
import RenderConnectionAccordion from '@/Components/AccordionConnections/RenderConnections'
import RenderOutputAccordion from '@/Components/AccordionConnections/RenderOutputAccordion'
...
const EditorCanvasSidebar = ({ nodes }: Props) => {
  ...
  const { googleFile, setSlackChannels } = useMavexaStore()
  useEffect(() => {
    if (state) {
