      ...
      <div className="w-full p-5 mx-auto bg-white dark:bg-neutral-900 shadow-2xl group h-full">
        <div className="flex flex-1 w-full h-full flex-col space-y-2">
          <img
            ...
            width={800}
            height={800}
            className="w-full h-full md:max-w-[100%] nd:h-auto aspect-square object-cover object-left-top rounded-sm mx-auto"
          />
        </div>
      </div>
      ...
      <div className="w-full p-5 mx-auto bg-white dark:bg-neutral-900 shadow-2xl group h-full">
        <div className="flex flex-1 w-full h-full flex-col space-y-2">
          <img
            ...
            width={800}
            height={800}
            className="w-full h-full md:max-w-[100%] md:h-auto aspect-square object-cover object-left-top rounded-sm mx-auto"
          />
        </div>
      </div>
      ...
      <div className="flex flex-row -ml-20">
        {images.map((image, idx) => (
          <motion.div
            ...
            whileTap="whileTap"
            className="rounded-xl -mr-4 mt-4 p-1 bg-white dark:bg-neutral-800 dark:border-neutral-700 border border-neutral-200 flex-shrink-0 overflow-hidden"
          >
            <img
              src={image}
              alt="bali images"
